...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <form method="post" action="updatecustomerdetails">
        <div class="user-details">
          
          <div class="input-box">
            <span class="details">Username</span>
            <input type="text" name="username" placeholder="Enter your username" value="${customer.username}" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text"  name="phonenumber" placeholder="Enter your number" value="${customer.phonenumber}"  required>
          </div>        
        </div>
        <div class="button">
